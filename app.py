...
# ==========================================
# UI: HEADER & WORKFLOW INSTRUCTIONS
# ==========================================
st.markdown("<h1 style='text-align: center;'>Provider Utilization and Logistics Scheduling Engine</h1>", unsafe_allow_html=True)
st.markdown("---")
...
# ==========================================
# MODULE 1: A.R.M. (Automated Re-scheduling Module)
# ==========================================
with st.container(border=True):
    st.markdown("<h2 style='color: #2563EB;'>Step 1: A.R.M. (Automated Re-scheduling Module)</h2>", unsafe_allow_html=True)
...
# ==========================================
with st.container(border=True):
    st.markdown("<h2 style='color: #7C3AED;'>Step 3: P.U.L.S.E. Engine Generation</h2>", unsafe_allow_html=True)
    st.markdown("Upload your completed ARM schedule and PLANS leave requests to generate the final optimal schedule.")
    
    col1, col2 = st.columns(2)
    with col1:
        st.subheader("1. Date Setup")
        anchor_date = st.date_input("Select SUNDAY 1a Start Date")
    ...
    # UI: EXECUTION
    # ==========================================
    if st.button("Generate P.U.L.S.E. Schedule", type="primary", use_container_width=True):
        if not roster_file:
            ...
            with st.spinner("Spinning up PULSE Engine. Crunching 10 million possibilities (Max 24 mins)..."):
                ...
                if final_schedule:
                    ...
                    st.error("Engine Status: INFEASIBLE. The rules contradict each other; no schedule is mathematically possible.")        {"name": "BOU, C", "initials": "CB", "role": "MD"},
        {"name": "CABATU, A", "initials": "ACC", "role": "MD"},
        {"name": "DE LEON, M", "initials": "MDT", "role": "MD"},
        {"name": "DOMINGUEZ, G", "initials": "GJDP", "role": "MD"},
        {"name": "DOTSON, T", "initials": "TMD", "role": "MD"},
